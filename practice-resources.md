...
| **4** | ~~**LetsDefend**~~ | Alert queue simulating Tier 1 triage | Free tier confirmed | **⚠️ Evaluated and dropped, 2026-09-04.** Clunky interface and poorly worded quizzes, and the preference is for real work over simulation. **Replaced by homelab time** — it was a rehearsal for a SOC being built anyway, and the real one is better. Revisit only if the lab stalls |
